...
(drones) and confuser objects (birds) that share similar visual characteristics
at distance.
...
Chapter~4 presents training and evaluation results. Chapter~5 discusses the
findings. Chapter~6 concludes with recommendations.
...
that complement the BirdDrone-2C-FT model:
...
\begin{enumerate}
  ...
  \item \textbf{Negligible regression on original test sets}: $-$0.005 on
        ...
        forgetting.
  \item \textbf{The distributed control center v2} provides a complete
