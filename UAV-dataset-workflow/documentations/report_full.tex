...
\begin{itemize}
  \item BirdDrone-2C-FT achieves mAP@0.5 = 0.969 on the combined validation
...
\begin{itemize}
  \item The system is trained and evaluated exclusively on RGB imagery.
        Thermal infrared detection --- which enables 24/7 operation
        regardless of lighting conditions --- is not addressed in the
        current work.
  \item The training data does not include weather-augmented samples
...
\begin{itemize}
  \item \textbf{Thermal infrared modality}: Build a custom thermal dataset
        following the pipeline of Delleji et al.~\cite{delleji2025thermal}
        and train a thermal detection branch for 24/7 operation.
